...
import { MessageCircle, Mail, Phone, Share2, Globe, Settings, Mic, Users } from 'lucide-react';
...
const Services: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      description: "AI that writes and sends personalized email campaigns. Boost your reply rate without lifting a finger."
    },
    {
      icon: Phone,
      title: "Automated Phone Callers",
      description: "Let AI handle phone-based appointment setting, lead follow-ups, and customer satisfaction surveys. Real human-like voices."
    },
    {
      icon: Share2,
